    ...
    <div class="mr-3 ml-3 mb-3 row justify-content-center">
      ...
      <div class="card m-5 p-2 pt-3 shadow" id="form-box">
        <div class="m-1 pt-4 mt-2 ml-5 mr-5" id="addOption">
          <h4 class="text-center font-weight-normal">Create Schedule</h4>
          <p class="pt-3 font-weight-light">Fill out the form completely to create a schedule.</p>
        ...
        <div class="col text-center" id="addForm">
          <form class="" action="../schedules/addsched.php?class_id=<?php echo $classid?>" method="POST">
            <input class="w-100 mb-2" type="text" placeholder="School Year" name="sy" required> 
            <select class="w-100 mb-2" name="curriculumname" id="form-fill" required>
                <option value="" disabled selected hidden>Choose Curriculum</option>
                <?php
                    $query = "SELECT * FROM curriculum where course_id = $courseID";
                    $results = mysqli_query($dbc, $query);
                    while($res = mysqli_fetch_array($results)){
                ?>
                    <option name="" value="<?php echo $res['curriculum_id']?>"><?php echo $res['curriculum_name']?></option>
            ...
            <select class="w-100 mb-2" name="semester" id="form-fill" required>
                <option value="" disabled selected hidden>Choose Semester</option>
                <option name="" value="1">First Semester</option>
                <option name="" value="2">Second Semester</option>
            </select>
      ...
      ?>
          <div class="card m-5 p-5 shadow" id="curriculum">
            ...
            <?php
                ...
                if($res['stats'] == "Draft"){
            ?>
                <p class="text-center font-weight-light text-primary"> <?php echo $res['stats']?></p>
            <?php
                }
                else{
            ?>
                <p class="text-center font-weight-light text-success"> <?php echo $res['stats']?></p>
            <?php
                }
            ?>
