...
<?php
    ...
    <div class="text-center flex-row justify-content-center mb-2" id="head-detail">
        <a href="./firstyear.php?curriculum_id=<?php echo $currentID?>?year3" class="btn text-primary btn mr-2 ml-2 p-1" id="action-btn">1</a>
                ...
                <table class="table" id="list">
                    ...
                    <tr>
                        <form action="../subjects/addsubjects.php?curriculum_id=<?php echo "$currentID" ?>?year3" method="POST">
                            ...
                            <input type="hidden" value="Third Year" name="yrlvl" required>
                    ...
                    <?php
                        ...
                        $results = mysqli_query($dbc, $query);
                        while($res = mysqli_fetch_array($results)){
                            if($res['curriculum_id'] == $currentID && $res['semester'] == $fsem && $res['year_level'] == "Third Year"){   
                    ?>
                        <tr>
            ...
            <div class="col-xs-6 p-2">
                ...
                <table class="table" id="list">
                    ...
                    <?php
                        ...
                        $results = mysqli_query($dbc, $query);
                        while($res = mysqli_fetch_array($results)){
                            if($res['curriculum_id'] == $currentID && $res['semester'] == $Ssem && $res['year_level'] == "Third Year"){
