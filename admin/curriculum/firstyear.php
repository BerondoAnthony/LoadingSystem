...
<html lang="en">
  ...
  <body>
    ...
    <div class="pt-4 pl-1 pr-1 pb-5 flexbox card" id="container">
        <h3 class="text-center font-weight-light"><?php echo "First Year" ?></h3>
                        ...
                        <tr>
                            <form action="../subjects/editsubjects.php?subject_id=<?php echo $res['subject_id']?>?year1" method="POST">
                                ...
                                <td class="font-weight-bold text-center">
                                    ...
                                    <a href="../subjects/deletesubjects.php?subject_id=<?php echo $res['subject_id']?>?year1" class="btn text-danger btn-sm" id="action-btn">
                                        <i class="fa fa-trash"></i>
                                    </a>
                                </td>
                            </form>
