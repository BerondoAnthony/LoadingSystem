...
<?php
    ...
    <div class="text-center flex-row justify-content-center mb-2" id="head-detail">
        <a href="./firstyear.php?curriculum_id=<?php echo $currentID?>?year4" class="btn text-primary btn mr-2 ml-2 p-1" id="action-btn">1</a>
    ...
    <div class="pt-4 pl-1 pr-1 pb-5 flexbox card" id="container">
        <h3 class="text-center font-weight-light"><?php echo "Fourth Year" ?></h3>
        <div class="row justify-content-center">
            <div class=" col-xs-4 p-2">
                ...
                <table class="table" id="list">
                    ...
                    <tr>
                        <form action="../subjects/addsubjects.php?curriculum_id=<?php echo "$currentID" ?>?year4" method="POST">
                            <input type="hidden" value="First" name="semester" required>
                            <input type="hidden" value="Fourth Year" name="yrlvl" required>
                    ...
                    <?php
                        ...
                        $results = mysqli_query($dbc, $query);
                        while($res = mysqli_fetch_array($results)){
                            if($res['curriculum_id'] == $currentID && $res['semester'] == $fsem && $res['year_level'] == "Fourth Year"){   
                    ?>
                        <tr>
                            <form action="../subjects/editsubjects.php?subject_id=<?php echo $res['subject_id']?>?year4" method="POST">
                                <fieldset disabled>
                                    <td class="font-weight-bold text-center">
                                ...
                                <td class="font-weight-bold text-center">
                                    ...
                                    <a href="../subjects/deletesubjects.php?subject_id=<?php echo $res['subject_id']?>year4" class="btn text-danger btn-sm" id="action-btn">
                                        <i class="fa fa-trash"></i>
                                    </a>
                                </td>
                            </form>
            ...
            <div class="col-xs-6 p-2">
                ...
                <table class="table" id="list">
                    ...
                    <?php
                        ...
                        $results = mysqli_query($dbc, $query);
                        while($res = mysqli_fetch_array($results)){
                            if($res['curriculum_id'] == $currentID && $res['semester'] == $Ssem && $res['year_level'] == "Fourth Year"){
