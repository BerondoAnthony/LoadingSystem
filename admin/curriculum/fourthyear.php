                ...
                <table class="table" id="list">
                    ...
                    <tr>
                        <form action="../subjects/addsubjects.php?curriculum_id=<?php echo "$currentID" ?>?year4" method="POST">
                            ...
                            <input type="hidden" value="4" name="yrlvl" required>
                    ...
                    <?php
                        ...
                        $results = mysqli_query($dbc, $query);
                        while($res = mysqli_fetch_array($results)){
                            if($res['curriculum_id'] == $currentID && $res['semester'] == $fsem && $res['year_level'] == "4"){   
                    ?>
                        <tr>
            ...
            <div class="col-xs-6 p-2">
                ...
                <table class="table" id="list">
                    ...
                    <?php
                        ...
                        $results = mysqli_query($dbc, $query);
                        while($res = mysqli_fetch_array($results)){
                            if($res['curriculum_id'] == $currentID && $res['semester'] == $Ssem && $res['year_level'] == "4"){
